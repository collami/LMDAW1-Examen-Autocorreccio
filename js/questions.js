...
window.onload = function () {
    ...
    xhttp.open("GET", "https://rawgit.com/collami/prueba/master/questions.xml", true);
    xhttp.send();
}
...
function corregirMultiple() {
    for (n = 2; n < 4; n++) {
        ...
        if (n == 2 && mal == true) {
            darExplicacion("  >>>Respuestas correctas: b, c, d");
        } else if (n == 3 && mal == true) {
            darExplicacion("  >>>Respuestas correctas: a, b, d, e");
        }
...
function corregirText() {
    for (n = 4; n < 6; n++) {
        ...
        if (txt.toLowerCase() == respuestaText[n]) {
            ...
            darRespuestaHtml(">Pregunta " + (n + 1) + ": Incorrecta");
            if (n == 4) {
                darExplicacion("  >>>Respuesta correcta: return");
            } else {
                darExplicacion("  >>>Respuesta correcta: cliente");
            }
        }
...
function corregirCheckbox() {
    ...
    for (n = 8; n < 10; n++) {
        ...
        if (n == 8 && mal == true) {
            darExplicacion("  >>>Respuestas correctas: c");
        } else if (n == 9 && mal == true) {
            darExplicacion("  >>>Respuestas correctas: a, c, d, f");
        }
    }
